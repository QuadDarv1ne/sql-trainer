...
-- Cross-department assignments for advanced-8 (employees from 3+ depts on same project)
INSERT INTO assignments (employee_id, project_id, role, hours_worked) VALUES (4, 5, 'Консультант', 40);
INSERT INTO assignments (employee_id, project_id, role, hours_worked) VALUES (9, 5, 'Системный аналитик', 35);
INSERT INTO assignments (employee_id, project_id, role, hours_worked) VALUES (10, 1, 'Финансовый контролёр', 30);
`;
