...
import { DIFFICULTY_LABELS, DIFFICULTY_COLORS, type Difficulty } from '@/lib/training-tasks';
import { Play, Shuffle, X } from 'lucide-react';
import { t } from '@/lib/i18n';

export default function PracticeModeDialog() {
  const { practiceMode, startPracticeMode, stopPracticeMode, nextPracticeTask } = useSQLTrainerStore();
    ...
    return (
      <div className="rounded-lg border-2 border-emerald-200 bg-emerald-50 p-3 dark:border-emerald-800 dark:bg-emerald-950/30">
        ...
        <div className="flex gap-2">
          ...
          <Button size="sm" variant="outline" className="flex-1" onClick={stopPracticeMode}>
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>{t('practiceMode.desc')}</DialogDescription>
        </DialogHeader>
